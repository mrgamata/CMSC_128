...
?>
	...
	if (isset($_POST["year"])){
    		$year=$_POST["year"];
    		$month=$_POST["month"];
			$_SESSION['taon'] = $_POST['year'];
	} 

	if (isset($_POST["month"])){
    		$year=$_POST["year"];
    		$month=$_POST["month"];
			$_SESSION['buwan'] = $_POST['month'];
		...
		<div class="gtco-container2">
			<div class="row">
				...
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading" style="width:90%">
					...
					$sql = "SELECT * FROM past_transaction natural join books natural join borrower where YEAR(borrow_date) = $year  AND MONTH(borrow_date) = $month
