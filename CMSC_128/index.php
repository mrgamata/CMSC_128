				...
				<div class="col-md-12 col-md-offset-0 text-left">
					...
					<div class="row row-mt-15em">
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							<span class="intro-text-small" style="color:#f0ad4e;">Teodoro Hernaez National High School</a></span>
							<h1 class="cursive-font" style="color:#f0ad4e;">Beacon of Wisdom and Values</h1>	
						</div>
		...
		<div class="gtco-container text-center">
			<div class="display-t">
				<div class="display-tc">
					<h1>&ldquo;Beacon of Wisdom and Values&rdquo;</h1>
